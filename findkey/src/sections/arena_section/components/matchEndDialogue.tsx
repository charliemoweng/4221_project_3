  ...
  const renderStats = () => {
    return (
      <DialogContentText sx={[{ marginTop: "30px" }]}>
        ...
        {props.isWin ? (
          <Typography>
            You found <b>all</b> team combinations that can wipe the enemy's
            team!
          </Typography>
        ) : (
          <Typography>
            You found <b>{props.combinationsFound}</b> team combinations that
            can wipe the enemy's team. But you are missing{" "}
            <b>{props.totalCombinations - props.combinationsFound}</b> other
            combinations.
          </Typography>
        )}
        {props.isWin && (
      ...
      <DialogContent>
        {props.isWin ? (
          <DialogContentText sx={styles.mainText}>
            <b>Congrats!</b> You found all the different combinations to wipe
            the enemy's team within the number of rounds!
          </DialogContentText>
        ) : (
          <DialogContentText sx={styles.mainText}>
            You were not able to find all the different combinations that can
            wipe the enemy's team in the allocated number of rounds.{" "}
